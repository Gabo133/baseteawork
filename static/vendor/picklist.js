...
(function ($, window) {
    ...
    PickList.DEFAULTS = {
        ...
        buttons: [
            {action: 'Agregar',label: 'Agregar',className: 'btn btn-sm btn-block btn-info'},
            {action: 'AgregarTodos',label: 'Agregar Todos',className: 'btn btn-sm btn-block btn-info'},
            {action: 'remove',label: 'Quitar',className: 'btn btn-sm btn-block btn-info'},
            {action: 'RemoverTodos',label: 'Quitar Todos',className: 'btn btn-sm btn-block btn-info'}
        ],
        buttonClass: 'btn btn-sm btn-block btn-primary',
        label: {
            content: ['En lista:', 'Seleccionados:']
        },
        select: {
            size: 15
        }
    ...
    PickList.prototype.initActions = function () {
        ...
        this.$element.find(".button-group .Agregar").on('click', function () {
            ...
            that.reload();
            that.trigger('Agregar', selectValue);
        ...
        this.$element.find(".button-group .AgregarTodos").on('click', function () {
        ...
        this.$element.find(".button-group .RemoverTodos").on('click', function () {
